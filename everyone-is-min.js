...
var temperatures = function(city) {
  var sortResults = {
    hot: [],
    warm: []
  };
  ...
  _.forEach(city, function(cityName, temperature) {
    if (_.every(cityName, checkTemp)) {
      return sortResults.hot.push(temperature);
    } else if (_.some(cityName, checkTemp)) {
      return sortResults.warm.push(temperature);
    }
  })
  return sortResults;
};
